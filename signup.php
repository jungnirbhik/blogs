...
<main class="form-signin w-100 m-auto">
  <form action="signup_process.php" method="POST">
    ...
    <div class="form-floating">
      <input name="email" type="email" class="form-control" id="floatingInput"  placeholder="someone@gmail.com">
    ...
    <div class="form-floating">
      <input name="repassword" type="repassword" class="form-control" id="floatingPassword" placeholder="repassword">
